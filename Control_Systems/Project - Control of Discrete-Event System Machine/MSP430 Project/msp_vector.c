	...
	while(1)
	{
		...
		if(mealy_output) //Se o evento ocorrido for válido, então imprimir saída física
		{
			switch(occur_event)
			{
				...
				case(1):	//Adicionar Ação para o Evento 1;

					break;
				case(3):	//Adicionar Ação para o Evento 3;

					break;
				case(7):	//Adicionar Ação para o Evento 7;

					break;
				case(9):	//Adicionar Ação para o Evento 9;

					break;
				case(13):	//Adicionar Ação para o Evento 13;

					break;
				case(15):	//Adicionar Ação para o Evento 15;

					break;
				case(19):	//Adicionar Ação para o Evento 19;

					break;
				case(21):	//Adicionar Ação para o Evento 21;

					break;
				case(23):	//Adicionar Ação para o Evento 23;

					break;
				case(25):	//Adicionar Ação para o Evento 25;

					break;
				//eventos não controláveis
				case(2):	//Adicionar Ação para o Evento 2;

					gerar_evento=1;
					break;
				case(4):	//Adicionar Ação para o Evento 4;

					gerar_evento=1;
					break;
				case(8):	//Adicionar Ação para o Evento 8;

					gerar_evento=1;
					break;
				case(10):	//Adicionar Ação para o Evento 10;

					gerar_evento=1;
					break;
				case(14):	//Adicionar Ação para o Evento 14;

					gerar_evento=1;
					break;
				case(16):	//Adicionar Ação para o Evento 16;

					gerar_evento=1;
					break;
				case(20):	//Adicionar Ação para o Evento 20;

					gerar_evento=1;
					break;
				case(22):	//Adicionar Ação para o Evento 22;

					gerar_evento=1;
					break;
				case(24):	//Adicionar Ação para o Evento 24;

					gerar_evento=1;
					break;
				case(30):	//Adicionar Ação para o Evento 30;

					gerar_evento=1;
					break;
				case(34):	//Adicionar Ação para o Evento 34;
