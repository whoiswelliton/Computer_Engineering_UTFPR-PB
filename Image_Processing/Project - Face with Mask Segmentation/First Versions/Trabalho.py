...
points = circle_points(100, [120, 300], 200)[:-1]


#fig, ax = image_show(image)
#ax.plot(points[:, 0], points[:, 1], '--r', lw=3)

#snake = seg.active_contour(binary_sauvola,points,alpha=0.09,beta=0.05, w_line=-0.5, w_edge=0, gamma=0.3)

snake = seg.active_contour(binary_sauvola,points,alpha=0.3,beta=0.05, gamma=0.3, w_line=0.5, w_edge=0.5)
